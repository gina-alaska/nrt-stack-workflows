...
#Clavrx
clarvx_list = ["NOAA20_CLAVRX_AWIPS_Job", "SNPP_CLAVRX_AWIPS_Job", "MetopB_CLAVRX_AWIPS_Job", "MetopC_CLAVRX_AWIPS_Job", "Amsr2Level2"]
#nucaps
nucaps = [ "MetopCNucapsConvert", "MetopBNucapsConvert", "Noaa20NucapsConvert", "Noaa21NucapsConvert", "Noaa21NucapsConvert"]
list += clarvx_list
list += nucaps
list.each do |item|
    steps = {}
